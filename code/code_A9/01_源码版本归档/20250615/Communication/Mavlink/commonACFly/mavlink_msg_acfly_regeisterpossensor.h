...
#define MAVLINK_MSG_ID_ACFly_RegeisterPosSensor_CRC 175
...
#define MAVLINK_MESSAGE_INFO_ACFly_RegeisterPosSensor { \
    ...
    {  { "target_system", NULL, MAVLINK_TYPE_UINT8_T, 0, 20, offsetof(mavlink_acfly_regeisterpossensor_t, target_system) }, \
         ...
         { "ind", NULL, MAVLINK_TYPE_INT8_T, 0, 38, offsetof(mavlink_acfly_regeisterpossensor_t, ind) }, \
...
static inline uint16_t mavlink_msg_acfly_regeisterpossensor_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
                               uint8_t target_system, uint8_t target_component, const char *sensor_name, int8_t ind, uint8_t type, uint8_t DataFrame, uint8_t DataType, float delay, float trustXY, float trustZ, float LTTrustXY, float LTTrustZ)
{
...
static inline void mavlink_msg_acfly_regeisterpossensor_send(mavlink_channel_t chan, uint8_t target_system, uint8_t target_component, const char *sensor_name, int8_t ind, uint8_t type, uint8_t DataFrame, uint8_t DataType, float delay, float trustXY, float trustZ, float LTTrustXY, float LTTrustZ)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_ACFly_RegeisterPosSensor_LEN];
    _mav_put_float(buf, 0, delay);
