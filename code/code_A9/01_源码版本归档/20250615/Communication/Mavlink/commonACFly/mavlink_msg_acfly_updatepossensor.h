...
#define MAVLINK_MSG_ID_ACFly_UpdatePosSensor_CRC 202
#define MAVLINK_MSG_ID_209_CRC 202
...
#define MAVLINK_MESSAGE_INFO_ACFly_UpdatePosSensor { \
    ...
    {  { "target_system", NULL, MAVLINK_TYPE_UINT8_T, 0, 56, offsetof(mavlink_acfly_updatepossensor_t, target_system) }, \
         ...
         { "ind", NULL, MAVLINK_TYPE_INT8_T, 0, 58, offsetof(mavlink_acfly_updatepossensor_t, ind) }, \
...
static inline uint16_t mavlink_msg_acfly_updatepossensor_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
                               uint8_t target_system, uint8_t target_component, int8_t ind, int8_t DataType, double posX, double posY, double posZ, float velX, float velY, float velZ, float delay, float trustXY, float trustZ, float LTTrustXY, float LTTrustZ, uint8_t reset, const float *AttQuat)
{
