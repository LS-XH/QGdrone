...
/*MS5803*/
	...
	static void Pitot_Server(void* pvParameters)
	{
		//操作结果
		bool res;
	ScanExtBaro:	
...
static bool I2C_Pitot_DriverInit()
{
	return true;
}
static bool I2C_Pitot_DriverRun()
{
	xTaskCreate( Pitot_Server, "Pitot", 1500, NULL, SysPriority_ExtSensor, NULL);
	return true;
}

void init_drv_Pitot()
{
	I2CFunc_Register( 33, I2C_Pitot_DriverInit, I2C_Pitot_DriverRun );
}
